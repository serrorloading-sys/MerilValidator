...
Run these commands in your **Supabase Dashboard > SQL Editor** to create the necessary table for registered users.
...
-- This ensures every new user gets an entry in 'profiles'
